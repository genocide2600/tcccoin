...
This document provides guidelines for internationalization of the tcccoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tcccoin_en.ts` remains unchanged.

tcccoin Core version 0.10.4 is now available from:

  <https://tcccoin.org/bin/tcccoin-core-0.10.4/>
...
- #6953 `43c2789` Split tcccoin-tx into its own package
- #6953 `dfe0d4d` Include tcccoin-tx binary on Debian/Ubuntu

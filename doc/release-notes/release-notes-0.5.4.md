tcccoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/tcccoin/files/tcccoin/tcccoin-0.5.4/
...
http://gitorious.org/tcccoin/tcccoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix tcccoin-Qt notifications under Growl 1.3.
Increase required age of tcccoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxtcccoin properly when installing tcccoin-Qt over it. (Windows)

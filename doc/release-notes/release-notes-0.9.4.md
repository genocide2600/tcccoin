tcccoin Core version 0.9.4 is now available from:

  https://tcccoin.org/bin/0.9.4/
...
this update is incompatible with the tcccoin system and could lead to consensus
forks.

tcccoin Core released binaries from https://tcccoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~tcccoin/+archive/ubuntu/tcccoin
- A third-party or self-compiled tcccoin Core

upgrade to tcccoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

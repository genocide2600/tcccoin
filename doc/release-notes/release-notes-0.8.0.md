tcccoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/tcccoin/files/tcccoin/tcccoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the tcccoin
...
New/changed settings (command-line or tcccoin.conf file)
--------------------------------------------------------

tcccoin Core version 0.13.2 is now available from:

  <https://tcccoin.org/bin/tcccoin-core-0.13.2/>
...
- #8908 `4a974b2` Update tcccoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow tcccoin-tx to create v2 transactions (btcdrak)

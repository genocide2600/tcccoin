...
class BIP66Test(tcccoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # tcccoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and tcccoind produces more specific reject
            # reasons.

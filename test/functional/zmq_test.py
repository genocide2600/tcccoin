...
from test_framework.test_framework import tcccoinTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (tcccoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that tcccoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("tcccoind has not been built with zmq enabled.")

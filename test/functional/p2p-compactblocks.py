...
# TestNode: A peer we use to send messages to tcccoind, and store responses.
...
class CompactBlocksTest(tcccoinTestFramework):
    ...
    # This test actually causes tcccoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that tcccoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for tcccoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # tcccoind will not send blocktxn responses for blocks whose height is

...
#include "qt/tcccoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<tcccoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_tcccoin-qt -platform xcb      # Linux
//     src/qt/test/test_tcccoin-qt -platform windows  # Windows
//     src/qt/test/test_tcccoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = tcccoinUnits::formatWithUnit(unit, balance, false, tcccoinUnits::separatorAlways);
    ...
    // Amount input
    tcccoinAmountField* amountInput = receiveCoinsDialog.findChild<tcccoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: tcccoin:")) != -1);

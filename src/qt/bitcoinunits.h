...
#ifndef tcccoin_QT_tcccoinUNITS_H
#define tcccoin_QT_tcccoinUNITS_H
...
/** tcccoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class tcccoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit tcccoinUnits(QObject *parent);

    /** tcccoin units.
      @note Source: https://en.tcccoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef tcccoinUnits::Unit tcccoinUnit;

#endif // tcccoin_QT_tcccoinUNITS_H

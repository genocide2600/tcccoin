...
#ifndef tcccoin_TEST_SCRIPTNUM10_H
#define tcccoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from tcccoin Core 0.10.0, for cross-comparison.
 */
public:
